        ...
        <section className="flex flex-col items-center justify-center text-center space-y-5 lg:h-screen h-screen lg:font-light ">
          <div className="max-w-xl ">
            <h1>
              ...
              implementing new technologies and concepts. I have a proven track
              record of reducing team stress, introducing innovative ideas, and
              improving existing projects. My collaborative approach helps
              create a more efficient and harmonious work environment while
