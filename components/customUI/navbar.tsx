...
const Navbar = () => {
  ...
  return (
    <nav className="z-50 bg-white dark:bg-transparent bg-opacity-40  backdrop-blur-lg font-normal  rounded-xl p-2 list-none flex flex-row gap-10  justify-between dark:shadow-md shadow-md   dark:shadow-pink-200   items-center  ">
      <section className="flex items-center space-x-10">
        <div className="">
          <h1 className={`${windSong.className} text-3xl`}> Manshul</h1>
        </div>
      </section>
